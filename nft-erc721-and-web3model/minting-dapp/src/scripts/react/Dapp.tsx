...
export default class Dapp extends React.Component<Props, State> {
  ...
  web3Modal = new Web3Modal({
    ...
    providerOptions: {
      walletconnect: {
        ...
        options: { 
          infuraId: "d7e5d20ab0ee444ab604d0ef24a23a59",
          rpc: {
            1: "https://mainnet.infura.io/v3/d7e5d20ab0ee444ab604d0ef24a23a59",
            42: "https://kovan.infura.io/v3/d7e5d20ab0ee444ab604d0ef24a23a59",
            137: "https://polygon-mainnet.infura.io/v3/d7e5d20ab0ee444ab604d0ef24a23a59",
  ...
  const browserProvider = await this.web3Modal.connect();
  const web3= new Web3(browserProvider);

  await detectEthereumProvider();
  

  console.log("browsweprovider", browserProvider)
  ...
  private async initWallet(): Promise<void>
  {
    ...
    console.log("===========",CollectionConfig.mainnet.chainId)
    console.log("===========",CollectionConfig.testnet.chainId)
